...
class ObjFunc(Protocol[R, SampleT]):
    ...
    def eval_sample(self, sample: SampleT) -> R:
    ...
    def eval_samples(self, samples: Iterable[SampleT]) -> Sequence[R]:
...
class Optimizer(ABC, Generic[C, R, SampleT]):
    ...
    @abstractmethod
    def optimize(self, func: ObjFunc[C, SampleT], params: Params) -> R:
