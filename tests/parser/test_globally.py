...
class GloballyTestCase(ParserTestCase):
    def test_globally_infinite(self) -> None:
        self.assertIsInstance(parse(r"[](1, inf) pred1", self._preds), mtl.Global)
    ...
    def test_globally_with_and(self) -> None:
        self.assertIsInstance(parse(r"G(1, 1000) (pred1 && pred2)", self._preds), mtl.Global)

    def test_globally_with_or(self) -> None:
        self.assertIsInstance(parse(r"[](25, 3000) (pred2 | pred3)", self._preds), mtl.Global)
