...
class FinallyTestCase(ParserTestCase):
    def test_finally_infinite(self) -> None:
        self.assertIsInstance(parse(r"<>(1, inf) pred1", self._preds), mtl.Finally)
    ...
    def test_finally_with_and(self) -> None:
        self.assertIsInstance(parse(r"F(1, 1000) (pred1 && pred2)", self._preds), mtl.Finally)

    def test_finally_with_or(self) -> None:
        self.assertIsInstance(parse(r"<>(25, 3000) (pred2 | pred3)", self._preds), mtl.Finally)
